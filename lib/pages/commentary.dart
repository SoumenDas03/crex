...
class commententary extends StatefulWidget {
  const commententary({Key? key, required this.id, required this.theme, required this.fullMatchName})
      : super(key: key);
...
class _commententaryState extends State<commententary> {
  ...
  Future<void> apiFetch() async {
    ...
    await Future.wait(
            [getSingleCricketMatchDetails(), getMatchScores(), getBallByBall(), getLiveBettingPoints(widget.fullMatchName, widget.id),])
        .then((v) {
      for (var item in v) {
        print('$item \n');
      }
                                                ...
                                                if (lastItem != null && lastItem["dismissal"] == null) {
                                                  ...
                                                  for (int i = bbbList.length - 1; i >= 0 && i >= bbbList.length - 6; i--) {
                                                    ...
                                                    if (currentItem != null && currentItem["runs"] != null) {
                                                      runs = (runs ?? 0) + (currentItem["runs"] as int); // Explicitly cast to int
                                                    }
                                                  }
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        decoration: BoxDecoration(
                                          color: bbbData != null && bbbData != "failure"
                                              ? bbbData["bbb"] != null &&
                                              bbbData["bbb"].length >= 6 &&
                                              bbbData["bbb"][bbbData["bbb"].length - 6]["dismissal"] == null
                                              ? (bbbData["bbb"][bbbData["bbb"].length - 6]["runs"] == 4
                                              ? Colors.amber
                                              : bbbData["bbb"][bbbData["bbb"].length - 6]["runs"] == 6
                                              ? Colors.green
                                              : Colors.transparent)
                                              : Colors.red
                                              : Colors.transparent,
                                      ...
                                      Container(
                                        decoration: BoxDecoration(
                                          color: bbbData != null && bbbData != "failure"
                                              ...
                                              ? (bbbData["bbb"][bbbData["bbb"].length - 4]["runs"] == 4
                                              ? Colors.amber
                                              : bbbData["bbb"][bbbData["bbb"].length - 4]["runs"] == 6
                                              ? Colors.green
                                              : Colors.transparent)
                                              : Colors.red)
                                              : Colors.transparent,
