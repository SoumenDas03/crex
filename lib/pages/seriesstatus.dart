...
class _seriesstatusState extends State<seriesstatus> {
  ...
  getSeriesDetails() async {
    try {
      http.Response response = await http.get(
        Uri.parse(
            'https://api.cricapi.com/v1/series_info?apikey=2c9a814a-4d49-468a-a7a7-63a76b3eb491&id=${widget.seriesId}'),
      );
