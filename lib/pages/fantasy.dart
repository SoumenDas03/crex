...
class _fantasyState extends State<fantasy> {
  ...
  Future getFantasyPoints() async {
    try {
      http.Response response = await http.get(
        Uri.parse(
            'https://api.cricapi.com/v1/match_points?apikey=dfe5a856-430f-49e9-99f4-6a994d3d76e8&id=${widget.id}&ruleset=0'),
      );
  ...
  Future getMatchScores() async {
    try {
      ...
      sixesOrderdata = sugamSixes.reversed.toList();
      if (response.statusCode == 200) {
        return scoreData;
        // ignore: use_build_context_synchronously
      } else {
                                                                              ...
                                                                              ? Text(
                                                                                  bbbData != "failure"
                                                                                      ? bbbData["bbb"][bbbData["bbb"].length - 1]["dismissal"] == null
                                                                                          ...
                                                                                          : "W"
                                                                                      : "1",
                                                                                  style: TextStyle(fontWeight: FontWeight.bold, color: isDarkMode ? Colors.amber : Colors.blueGrey, fontSize: 50),
                                                                                )
                                                                              : Image.asset(
                                                                                  "assets/wicket.gif",
                                                                                  scale: 5,
                                                                  ...
                                                                  ? data["score"].length >
                                                                      ...
                                                                      ? data["teamInfo"][data["score"].length - 3]["shortname"] +
                                                                          ...
                                                                          data["score"][data["score"].length - 3]["o"]
                                                                              .toString() +
                                                                          ")"
                                                                      : data["teamInfo"][data["score"].length - 1]["shortname"] + " " + data["score"][data["score"].length - 2]["r"].toString() + "-" + data["score"][data["score"].length - 2]["w"].toString() + "(" + data["score"][data["score"].length - 2]["o"].toString() + ")"
                                                                ...
                                                                bbbData !=
                                                                    ...
                                                                    ? bbbData["bbb"][bbbData["bbb"].length - 1]["dismissal"] ==
                                                                        ...
                                                                        ? (bbbData["bbb"][bbbData["bbb"].length - 1]["runs"] ??
                                                                                ...
                                                                                1 + bbbData["bbb"][bbbData["bbb"].length - 4]["runs"] + bbbData["bbb"][bbbData["bbb"].length - 5]["runs"] ??
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            Text(
                                                                              pointsOrderData[index]["points"].toString(),
                                                                              style: TextStyle(color: Color(0xFFFF4D00), fontSize: 12),
                                                                            ),
                                                                            Text(
                                                                              'Points',
                                                                              style: TextStyle(color: Color(0xFFFF4D00), fontSize: 12),
                                                                    ...
                                                                    children: [
                                                                      Container(
                                                                        ...
                                                                        decoration:
                                                                            BoxDecoration(
                                                                          border:
                                                                              Border.all(color: isDarkMode ? Colors.white : Colors.blueGrey),
                                                                        ),
                                                                        child:
                                                                            Icon(
                                                                          Icons
                                                                      ...
                                                                      Column(
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            scoreOrderData[index]["batsman"]["name"],
                                                                            style:
                                                                          ...
                                                                          Text(
                                                                            scoreOrderData[index]["dismissal-text"],
                                                                            style:
                                                                                TextStyle(color: isDarkMode ? Colors.white : Colors.black, fontSize: 12),
                                                                          ),
                                                                        ],
                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            Text(
                                                                              scoreOrderData[index]["r"].toString(),
                                                                              style: TextStyle(color: Color(0xFFFF4D00), fontSize: 12),
                                                                            ),
                                                                            Text(
                                                                              'Runs',
                                                                  ...
                                                                  Row(
                                                                    children: [
                                                                      ...
                                                                      Column(
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            wicketOrderData[index]["bowler"]["name"],
                                                                            style:
                                                                                TextStyle(color: isDarkMode ? Colors.white : Colors.black, fontSize: 12),
                                                                          ),
                                                                          SizedBox(
                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            Text(
                                                                              wicketOrderData[index]["w"].toString(),
                                                                              style: TextStyle(color: Color(0xFFFF4D00), fontSize: 15),
                                                                            ),
                                                                            Text(
                                                                              'Wickets',
                                                                              style: TextStyle(color: Color(0xFFFF4D00), fontSize: 12),
                                                                  ...
                                                                  Row(
                                                                    children: [
                                                                      ...
                                                                      Column(
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            sixesOrderdata[index]["batsman"]["name"],
                                                                            style:
                                                                                TextStyle(color: isDarkMode ? Colors.white : Colors.black, fontSize: 12),
                                                                          ),
                                                                          SizedBox(
                                                                  ...
                                                                  Row(
                                                                    children: [
                                                                      ...
                                                                      Column(
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            economySugam[index]["bowler"]["name"],
                                                                            style:
                                                                                TextStyle(color: isDarkMode ? Colors.white : Colors.black, fontSize: 12),
                                                                          ),
                                                                          SizedBox(
                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            Text(
                                                                              wicketOrderData[index]["eco"].toString(),
                                                                              style: TextStyle(color: Color(0xFFFF4D00), fontSize: 15),
                                                                            ),
                                                                            Text(
                                                                              'Economy',
