...
class bestStrikeRate extends StatefulWidget {
  const bestStrikeRate({super.key});

  @override
  State<bestStrikeRate> createState() => _bestStrikeRateState();
}

// ignore: camel_case_types
class _bestStrikeRateState extends State<bestStrikeRate> {
  bool status = false;
  @override
