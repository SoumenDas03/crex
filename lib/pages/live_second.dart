...
class live_second extends StatefulWidget {
  const live_second({Key? key, required this.id, required this.theme, required this.matchName, required this.fullMatchName, required this.getOver})
      : super(key: key);
...
class _live_secondState extends State<live_second> with WidgetsBindingObserver {
  ...
  Future<void> apiFetch() async {
    ...
    await Future.wait([
     ...
     // getBettingPoints(widget.fullMatchName),
    ]).then((v) {
      for (var item in v) {
        // print('$item \n');
      }
  ...
  var map, data, sugamWicket, wicketOrderData, bbbmap, bbbData, mapBetting, mapNoob, match_id, livePoints, liveSessionPoints, liveSessionPoints50, liveScore;
  bool flag = false;
  ...
  Future getLiveSession(String matchId,matchname, getOver) async {
    try{
      final response = await http.post(
          Uri.parse('https://playexch.us/api/get-match-session'),
          body: {"matchid": matchId,"matchname": matchname, "getover": getOver}
      );

      if(response.statusCode == 200) {
        var map = jsonDecode(response.body);
        liveSessionPoints = map["data"];
        liveSessionPoints50 = map["data1"];
      } else {
        print('Failed to fetch match session');
      }
    } catch(e) {
      print(e);
    }
            ...
            return Container(
              ...
              child: SingleChildScrollView(
                child: Column(children: [
                                      ...
                                      Text(
                                        (() {
                                          if (bbbData != "failure" && bbbData != null) {
                                            List<dynamic> bbbList = bbbData["bbb"];

                                            if (bbbList != null && bbbList.isNotEmpty) {
                                              Map<String, dynamic> lastItem = bbbList[bbbList.length - 1];

                                              if (lastItem != null && lastItem["dismissal"] == null) {
                                                int? runs = 0; // Make runs nullable

                                                for (int i = bbbList.length - 1; i >= 0 && i >= bbbList.length - 6; i--) {
                                                  Map<String, dynamic> currentItem = bbbList[i];

                                                  if (currentItem != null && currentItem["runs"] != null) {
                                                    runs = ((runs ?? 0) + currentItem["runs"]) as int?;
                                                  }
                                                }

                                                return runs?.toString() ?? "null"; // Handle nullable runs
                                              } else {
                                                return "8";
                                              }
                                            }
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    SizedBox(width: 24),
                                    Text(
                                      livePoints == null ? "--" : data["teamInfo"][0]["name"].toString().contains(livePoints[0]["favname"]) ?
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    livePoints == null ? "--" : livePoints[0]["back"] == "--" ? "--" : livePoints[0]["back"].toStringAsFixed(2).split(".")[1],
                                    style: TextStyle(
                                        fontSize: 20,
                                        fontWeight: FontWeight.bold,
                                        color: isDarkMode
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    livePoints == null? "--" : livePoints[0]["lay"] == "--" ? "--" : livePoints[0]["lay"].toStringAsFixed(2).split(".")[1],
                                    style: TextStyle(
                                        fontSize: 20,
                                        fontWeight: FontWeight.bold,
                                        color: isDarkMode
                  ...
                  Visibility(
                    visible: (liveSessionPoints != null && liveSessionPoints.length > 0) && numberview,
                    child: Padding(
                      padding: const EdgeInsets.all(5.0),
                      child: Container(
                        decoration: BoxDecoration(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                SizedBox(width: 24),
                                Text(
                                  liveSessionPoints != null &&  liveSessionPoints.length > 0 ? liveSessionPoints[0]["over"].toString().split(" ")[0] + " Ov Runs" : "--",
                                  style: TextStyle(
                                      color: isDarkMode
                                          ? Colors.white
                                          : Colors.black,
                            ...
                            Container(
                              ...
                              child: Text(
                                (liveSessionPoints == null || liveSessionPoints.length == 0) || liveSessionPoints[0]["oneLayPrice1"] == 0? "No  --" : "No  " + liveSessionPoints[0]["oneLayPrice1"].toString(),
                                style: TextStyle(
                                    fontSize: 20,
                                    fontWeight: FontWeight.bold,
                                    color: isDarkMode
                            ...
                            Container(
                              ...
                              child: Text(
                                (liveSessionPoints == null || liveSessionPoints.length == 0) || liveSessionPoints[0]["oneBackPrice1"] == 0 ? "Yes --" : "Yes  " + liveSessionPoints[0]["oneBackPrice1"].toString(),
                                style: TextStyle(
                                    fontSize: 20,
                                    fontWeight: FontWeight.bold,
                                    color: isDarkMode
                  ...
                  Visibility(
                    visible: (liveSessionPoints50 != null && liveSessionPoints50.length > 0) && numberview,
                    child: Padding(
                      padding: const EdgeInsets.all(5.0),
                      child: Container(
                        decoration: BoxDecoration(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                SizedBox(width: 24),
                                Text(
                                  liveSessionPoints50 != null ? liveSessionPoints50[0]["over"].toString().split(" ")[0] + " Ov Runs" : "--",
                                  style: TextStyle(
                                      color: isDarkMode
                                          ? Colors.white
                                          : Colors.black,
                            ...
                            Container(
                              ...
                              child: Text(
                                liveSessionPoints50 == null || liveSessionPoints50[0]["oneLayPrice1"] == "0"? "No  --" : "No  " + liveSessionPoints50[0]["oneLayPrice1"].toString(),
                                style: TextStyle(
                                    fontSize: 20,
                                    fontWeight: FontWeight.bold,
                                    color: isDarkMode
                            ...
                            Container(
                              ...
                              child: Text(
                                liveSessionPoints50 == null || liveSessionPoints50[0]["oneBackPrice1"] =="0" ? "Yes --" : "Yes  " + liveSessionPoints50[0]["oneBackPrice1"].toString(),
                                style: TextStyle(
                                    fontSize: 20,
                                    fontWeight: FontWeight.bold,
                                    color: isDarkMode
