...
class bestSEchonomy extends StatefulWidget {
  const bestSEchonomy({super.key});

  @override
  State<bestSEchonomy> createState() => _bestSEchonomyState();
}

// ignore: camel_case_types
class _bestSEchonomyState extends State<bestSEchonomy> {
  bool status = false;
  @override
