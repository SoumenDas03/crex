  ...
  getPlayerInfo() async {
    try {
      http.Response response = await http.get(
        Uri.parse(
            'https://api.cricapi.com/v1/players_info?apikey=272ffee7-f333-43bd-babc-f9e045d698d3&id=${widget.playerId}'),
      );
                              ...
                              Row(
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Text(
                                      (int.parse(totalRunList[0]["value"]) +
                                              int.parse(
