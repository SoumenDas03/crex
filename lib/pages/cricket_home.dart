...
class _cricket_homeState extends State<cricket_home> {
  ...
  getCricketDetails() async {
    try {
      ...
      data = map["data"]
          .where((element) => element["matchEnded"] == false)
          .toList();
                                                                    ...
                                                                    children: [
                                                                      CircleAvatar(
                                                                        radius:
                                                                            15,
                                                                        backgroundImage:
                                                                            NetworkImage(data[index]["teamInfo"][0]["img"].toString()),
                                                                      ),
                                                                      SizedBox(
                                                                        width:
                                                                            10,
                                                                      ...
                                                                      Row(
                                                                        children: [
                                                                          Text(
                                                                            ...
                                                                            data[index]["score"][0]["r"].toString() +
                                                                                "-" +
                                                                                data[index]["score"][0]["w"].toString() +
                                                                                "/",
                                                                            style: TextStyle(
                                                                                fontSize: 22,
                                                                                fontWeight: FontWeight.bold,
                                                                      ...
                                                                      CircleAvatar(
                                                                        radius:
                                                                            15,
                                                                        backgroundImage:
                                                                            NetworkImage(data[index]["teamInfo"][1]["img"].toString()),
                                                                      ),
                                                                      SizedBox(
                                                                        width:
                                                                            10,
