...
class fantasyPoints extends StatefulWidget {
  const fantasyPoints({super.key});

  @override
  State<fantasyPoints> createState() => _fantasyPointsState();
}

// ignore: camel_case_types
class _fantasyPointsState extends State<fantasyPoints> {
  bool status = false;
  @override
